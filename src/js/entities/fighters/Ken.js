import { FIGHTER_HURT_DELAY, FighterState, FrameDelay, HurtBox, PushBox } from "../../constants/fighter.js";
...
export class Ken extends Fighter {
    constructor(playerId, onAttackHit) {
        ...
        this.frames = new Map([
            // Idle Stance
            ['idle-1', [[[346, 688, 68, 89], [34, 86]], PushBox.IDLE, HurtBox.IDLE]],
            ...
            ['jump-roll-1', [[[1237, 1037, 55, 103], [25, 106]], PushBox.JUMP, [[-11, -106, 24, 16], [-26, -98, 48, 42], [-26, -31, 48, 32]]]],
            ['jump-roll-2', [[[1301, 990, 61, 78], [22, 90]], PushBox.JUMP, [[17, -90, 24, 16], [-14, -91, 48, 42], [-22, -66, 38, 18]]]],
            ...
            // Stand Turn
            ['idle-turn-1', [[[420, 682, 54, 95], [29, 92]], PushBox.IDLE, [[-10, -89, 28, 18], [-14, -74, 48, 42], [-14, -31, 46, 32]]]],
            ['idle-turn-2', [[[488, 678, 58, 98], [30, 95]], PushBox.IDLE, [[-16, -96, 28, 18], [-14, -74, 48, 42], [-14, -31, 48, 32]]]], 
            ['idle-turn-3', [[[560, 683, 54, 94], [27, 90]], PushBox.IDLE, [[-16, -96, 28, 18], [-14, -74, 40, 42], [-14, -31, 48, 32]]]],

            // Crouch Turn
            ['crouch-turn-1', [[[356, 802, 53, 61], [26, 58]], PushBox.CROUCH, [[-7, -68, 24, 18], [-28, -46, 44, 24], [-28, -24, 44, 24]]]],
            ['crouch-turn-2', [[[424, 802, 52, 61], [27, 58]], PushBox.CROUCH, [[-7, -68, 24, 18], [-28, -46, 44, 24], [-28, -24, 44, 24]]]], 
            ['crouch-turn-3', [[[486, 805, 53, 61], [29, 58]], PushBox.CROUCH, [[-26, -61, 24, 18], [-28, -46, 44, 24], [-28, -24, 44, 24]]]],
            ...
            // Heavy Punch
            ['heavy-punch-1', [[[736, 1148, 108, 94], [24, 92]], PushBox.IDLE, HurtBox.PUNCH, [17, -85, 68, 14]]],

            // Light Kick
            ['light-kick-1', [[[62, 1565, 66, 92], [46, 93]], PushBox.IDLE, [[-33, -96, 30, 18], [-41, -79, 42, 38], [-32, -52, 44, 508]]]],
            ...
            // Hit Face
            ['hit-face-1', [[[325, 3275, 62, 91], [41, 88]], PushBox.IDLE, [[-25, -89, 20, 20], [-33, -74, 40, 46], [-30, -37, 48, 38]]]],
            ...
            // Hit Stomach
            ['hit-stonach-1', [[[1, 3279, 58, 85], [37, 83]], PushBox.IDLE, [[-15, -85, 28, 18], [-31, -69, 42, 42], [-38, -34, 42, 34]]]],
            ["hit-stonach-2", [[[74, 3282, 66, 82], [39, 80]], PushBox.IDLE, [[-17, 82, 28, 18], [-33, -65, 38, 36], [-34, -34, 42, 34]]]],
            ['hit-stonach-3', [[[149, 3287, 71, 78], [47, 75]], PushBox.IDLE, [[-17, 82, 28, 18], [-41, -59, 38, 30], [-34, -34, 42, 34]]]],
            ['hit-stonach-4', [[[231, 3293, 75, 72], [50, 69]], PushBox.IDLE, [[-28, -67, 28, 18], [-41, -59, 38, 30], [-40, -34, 42, 34]]]],

            // Stunned
            ['stun-1', [[[149, 3370, 77, 87], [28, 85]], PushBox.IDLE, [[8, -87, 28, 18], [-16, -75, 40, 46], [-26, -31, 40, 32]]]],
            ['stun-2', [[[77, 3368, 65, 89], [28, 87]], PushBox.IDLE, [[-9, -89, 28, 18], [-23, -75, 48, 46], [-26, -31, 40, 32]]]], 
            ['stun-3', [[[1, 3367, 67, 90], [35, 88]], PushBox.IDLE, [[-22, -91, 28, 18], [-36, -72, 42, 40], [-26, -31, 40, 32]]]],

            // Death
            ['death-1', [[[1, 3504, 82, 68], [41, 65]], PushBox.IDLE, [[-41, -68, 20, 20], [-33, -51, 40, 42], [-30, -24, 48, 24]]]],
            ['death-2', [[[84, 3460, 102, 45], [41, 42]], PushBox.IDLE, [[-41, -68, 20, 20], [-33, -51, 40, 42], [-30, -24, 48, 24]]]],
            ['death-3', [[[709, 3568, 128, 31], [41, 28]], PushBox.IDLE, [[-41, -68, 20, 20], [-33, -51, 40, 42], [-30, -24, 48, 24]]]],
        ]);
        ...
        this.animations = {
            ...
            [FighterState.JUMP_BACKWARD] : [
                ['jump-roll-1', 15], ['jump-roll-6', 3], ['jump-roll-5', 3], 
            ...
            [FighterState.HIT_FACE_LIGHT]: [
                ['hit-face-1', 3], ['hit-face-2', FrameDelay.TRANSITION],
            ],
            [FighterState.HIT_FACE_MEDIUM]: [
                ['hit-face-1', 18], ['hit-face-2', 4], ['hit-face-3', FrameDelay.TRANSITION],
            ],
            [FighterState.HIT_FACE_HEAVY]: [
                ['hit-face-3', 18], ['hit-face-4', 7], ['stun-3', FrameDelay.TRANSITION],
            ],
            ...
            [FighterState.HURT_BODY_LIGHT]: [
                ['hit-stonach-1', FIGHTER_HURT_DELAY], ['hit-stonach-1', 11],
                ['hit-stonach-1', FrameDelay.TRANSITION],
            ],
            [FighterState.HURT_BODY_MEDIUM]: [
                ['hit-stonach-1', FIGHTER_HURT_DELAY], ['hit-stonach-1', 7],
                ['hit-stonach-2', 9], ['hit-stonach-2', FrameDelay.TRANSITION],
            ],
