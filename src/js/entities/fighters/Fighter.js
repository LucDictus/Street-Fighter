import { FighterState, FighterDirection, FrameDelay, PUSH_FRICTION } from "../../constants/fighter.js";
...
export class Fighter {
    ...
    resetVelocities() {
        this.velocity.x = FrameDelay.FREEZE;
        this.velocity.y = FrameDelay.FREEZE;
    }
